...
<section class="page-header page-header-xs">
	<div class="container">
		...
		<h1><i class="fa fa-book"></i> BYLAWS OF TXRA</h1>
...
<!-- /PAGE HEADER -->
			...
			<section>
				<div class="container" style="100%">
					...
					<div class="col-md-3 col-sm-4 alert-info">	
						<button class="btn btn-mobile hidden-sm hidden-md hidden-lg" data-toggle="collapse" data-target=".nav-filter-collapse">
							<i class="fa fa-bars"></i> Index of Articles
						</button>			
						<h4 class="hidden-xs">Index of Articles</h4>
						<div class="collapse navbar-collapse nav-filter-collapse" style="pading:0px">
							<ul class="nav nav-pills nav-stacked mix-filter margin-bottom-30" style="pading:0px">
								<li data-filter="one" class="filter"><a href="#"> I.Name</a></li>
								<li data-filter="two" class="filter"><a href="#"> II. Offices</a></li>
								<li data-filter="three" class="filter"><a href="#"> III. Membership</a></li>
								<li data-filter="four" class="filter"><a href="#"> IV. Meetings of Members</a></li>
								<li data-filter="five" class="filter"><a href="#"> V. Board of Directors </a></li>
								<li data-filter="six" class="filter"><a href="#"> VI. Officers</a></li>
								<li data-filter="seven" class="filter"><a href="#"> VII. Insurance</a></li>
								<li data-filter="eight" class="filter"><a href="#"> VIII. Compensation and Reimbursement </a></li>
								<li data-filter="nine" class="filter"><a href="#"> IX. Nondiscrimination</a></li>
								<li data-filter="ten" class="filter"><a href="#"> X. Amendments</a></li>
					...
					<div class="row mix-grid col-md-9 col-sm-8">					
						<!-- LEFT COLUMNS -->
