		...
		<div class="row">
	        <div class="col-md-8">
	          <div class="row">
	            ...
	            <form action="{{route('admin.referees.store')}}" method="post" enctype="multipart/form-data">
	            	{{ csrf_field() }}		
					...
					<div class="row">
            			<div class="form-group col-md-12">
							...
							<input type="text" name="logo" value="{{Input::old('logo')}}" class="form-control">
						</div>
					</div>
					<div class="row">
            			<div class="form-group col-md-12">
